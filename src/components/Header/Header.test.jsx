...
describe('components', () => {
  describe('Header', () => {
    it('should render Header correctly', () => {
      ...
      expect(wrapper.find('input').props().value).toBe(handledSearchValue);
    });
    ...
    it('should call onSearch callback', () => {
      ...
      expect(props.onSearch.mock.calls.length).toBe(2);
      expect(props.onSearch.mock.calls[1][0]).toBe(initSearchValue);
    });
    ...
    it('should update value and state on change', () => {
      ...
      expect(wrapper.find('input').props().value).toBe(newText);
